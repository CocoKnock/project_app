...
def load_data_collection_page_2():
    ...
    def set_label_next(label):
        ...
        # After selecting a class, go to camera capture (now step 2)
        switch_page("data_collection1")
...
def load_data_collection_audio_page():
    ...
    make_label(frame, f"Step 3: Audio ({selected_label.capitalize()})", font=FONT_TITLE).grid(row=0, pady=20)
...
def load_data_collection_page_3():
    ...
    def confirm_save():
        ...
        try:
            ...
            # Move Processed Image to Class Folder
