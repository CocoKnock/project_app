...
def load_fft_display_page():
    ...
    make_button(btn_frame, "RETAKE", lambda: switch_page("data_collection_audio"), width=150, fg_color="#C62828").pack(side="left", padx=20)
    make_button(btn_frame, "PROCEED TO SAVE", lambda: switch_page("data_collection3"), width=200).pack(side="left", padx=20)

    return frame
pages["fft_display"] = load_fft_display_page
